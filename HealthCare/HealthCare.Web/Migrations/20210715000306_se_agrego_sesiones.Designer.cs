...
namespace HealthCare.Web.Migrations
{
    ...
    [Migration("20210715000306_se_agrego_sesiones")]
    partial class se_agrego_sesiones
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HealthCare.Web.Models.Producto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("HealthCare.Web.Models.Sesion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("Automedicacion")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("HealthCare.Web.Models.Tratamiento", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("HealthCare.Web.Models.Usuario", b =>
                {
            ...
            modelBuilder.Entity("HealthCare.Web.Models.Sesion", b =>
                {
                    b.HasOne("HealthCare.Web.Models.Paciente", "Paciente")
                        .WithMany()
                        .HasForeignKey("PacienteId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("HealthCare.Web.Models.Patologia", "Patologia")
                        .WithMany()
                        .HasForeignKey("PatologiaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("HealthCare.Web.Models.Producto", "Producto")
                        .WithMany()
                        .HasForeignKey("ProductoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("HealthCare.Web.Models.Tratamiento", "Tratamiento")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("HealthCare.Web.Models.Usuario", null)
                        .WithMany()
